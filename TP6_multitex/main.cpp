...
int main()
{
    ...
    ctx.update = [&]() {
        ...
        int uTextureSecondaryId = glGetUniformLocation(shader.id(), "uTextureSecondary");

        // Transformations earth
        ...
        MVMatrix               = glm::rotate(MVMatrix, glm::radians(180.0f), {1.f, 0.f, 1.f});
        ...
        glBindTexture(GL_TEXTURE_2D, cloudTexId);
        glUniform1i(uTextureSecondaryId, 1);
